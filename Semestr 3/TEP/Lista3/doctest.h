...
#define DOCTEST_INTERNAL_ERROR(msg)                                                                \
    ...
    String::size_type String::size() const
    {
        ...
        } // using "last" would work only if "len" is 32
        return data.size;
    }
...
// =================================================================================================
        ...
        struct XmlReporter : public IReporter
        {
            ...
            {
                if (tc)
                { // the TestSuite tag - only if there has been at least 1 test case
                    xml.endElement();
                }
        ...
        struct JUnitReporter : public IReporter
        {
            ...
            void test_run_end(const TestRunStats &p) override
            {
                ...
                xml.startElement("testsuite").writeAttribute("name", binary_name)
                        .writeAttribute("_errors", testCaseData.totalErrors)
            ...
            {
                if (!rb.m_failed)
                { // report only failures & ignore the `success` option
                    return;
                }
